...
\Fn{\AuxiliaryFunctionIns{a}}{
    \Return CostoInsertar{[a]}\;  % Retornar el valor calculado por la función auxiliar
}

\Fn{\AuxiliaryFunctionDel{a}}{
% Acciones o cálculos auxiliares
    \Return CostoEliminar{[a]}\;}


\Fn{\AuxiliaryFunctionSub{a, b}}{
% Acciones o cálculos auxiliares
    \Return CostoSubtituir{[a][b]}\;
}

\Fn{\AuxiliaryFunctionTrans{a, b}}{
% Acciones o cálculos auxiliares
    \Return CostoTransponer{[a][b]}\;
}
\end{comment}
