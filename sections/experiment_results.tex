...
\begin{enumerate}
    ...
    es exponencial con respecto al tamaño más pequeño de la entrada, 
    ...
    se modela según los tamaños de las dos entradas más 1, por lo tanto, podríamos
    decir que le toma tiempo $1*9=9$, valor mayor con respecto al algoritmo de
    fuerza bruta.

    Además, los usos de memoria son similares ya que el algoritmo de 
